  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/luminous.svg" alt="Bolby" className="mb-4" />

          <h1 className="mb-2 mt-0">Olumide Samuel Oluwole</h1>
          <p>
            I'm a{" "}
            <Typed
              strings={["Helloooo", "Front-End Developer", "Writer"]}
              typeSpeed={100}
              backSpeed={40}
              attr="value"
              loop
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://github.com/luminousit" target="_blank">
                <i className="fab fa-github"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/sooluwole" target="_blank">
